...
import com.codefeedr.kafka.Validators.BatchSizeValidator;
import com.codefeedr.kafka.Validators.TimestampValidator;
...
public class GitHubSourceConnectorConfig extends AbstractConfig {
    ...
    public static ConfigDef conf() {
        return new ConfigDef()
                ...
                .define(OWNER_CONFIG, Type.STRING, Importance.LOW, OWNER_DOC)
                .define(REPO_CONFIG, Type.STRING, Importance.LOW, REPO_DOC)
